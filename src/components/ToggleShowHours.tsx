  ...
  return (
    <motion.button
      ...
      className={classNames(
        "relative h-10 w-24 rounded-full border-0 bg-transparent p-0 text-base font-bold backdrop-blur backdrop-filter transition-all duration-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500",
        (color === "gray" &&
